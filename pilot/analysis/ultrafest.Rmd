...
```{r}
smooth.df <- get_predictions(max.it.gam.AR, cond = list(c2phonation.ord = c("voiceless", "voiced"), X = seq(-39, 54, length = 200)))
...
#    geom_rect(aes(xmin = sig.diff$start, xmax = sig.diff$end,
...
```{r}
plot_grid(smooth.plot, diff.plot, align = "hv", nrow = 2, rel_heights = c(3/4, 1/4))
```
