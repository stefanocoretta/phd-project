...
```{r}
ggplot(pata.polish, aes(rel.time, TT.velocity)) +
    geom_line() +
    facet_grid(speaker ~ c2phonation + vowel)
```

```{r}
ggplot(pata.degg.polish, aes(rel.time, closed.quotient)) +
    geom_point() +
    facet_grid(speaker ~ c2phonation + vowel)
```

```{r}
ggplot(paka.polish, aes(rel.time, TD.velocity)) +
    geom_line() +
    facet_grid(speaker ~ c2phonation + vowel)
```

```{r}
ggplot(paka.degg.polish, aes(rel.time, closed.quotient)) +
    geom_point() +
    facet_grid(speaker ~ c2phonation + vowel)
```

```{r}
ggplot(pata.italian, aes(rel.time, TT.displacement.sm)) +
    geom_line() +
    facet_grid(speaker ~ c2phonation + vowel)
```

```{r}
ggplot(pata.degg.italian, aes(rel.time, closed.quotient)) +
    geom_point() +
    facet_grid(speaker ~ c2phonation + vowel)
```

```{r}
ggplot(paka.italian, aes(rel.time, TD.displacement.sm)) +
    geom_line() +
    facet_grid(speaker ~ c2phonation + vowel)
```

```{r}
ggplot(paka.degg.italian, aes(rel.time, closed.quotient)) +
    geom_point() +
    facet_grid(speaker ~ c2phonation + vowel)
```
