...
estimates <- read_csv("./english-ve-meta/estimates.csv") %>%
...
davis1989 <- read_csv("./english-ve-meta/davis1989.csv") %>%
...
```{r heffner1937}
h37 <- filter(estimates, study == "heffner1937")
...
h37_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./english-ve-meta/data/cache/h37_bm.Rdata"
)
```

```{r housefairbanks1953}
hf53 <- filter(estimates, study == "housefairbanks1953")
...
hf53_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./english-ve-meta/data/cache/hf53_bm.Rdata"
)
```

```{r petersonlehiste1960}
pl60 <- filter(estimates, study == "petersonlehiste1960")
...
pl60_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./english-ve-meta/data/cache/pl60_bm.Rdata"
)
```

```{r sharf1962}
s62 <- filter(estimates, study == "sharf1962")
...
s62_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./english-ve-meta/data/cache/s62_bm.Rdata"
)
```

```{r chen1970}
c70 <- filter(estimates, study == "chen1970")
...
c70_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./english-ve-meta/data/cache/c70_bm.Rdata"
)
```

```{r klatt1973}
k73 <- filter(estimates, study == "klatt1973")
...
k73_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./english-ve-meta/data/cache/k73_bm.Rdata"
)
```

```{r laeufer1992}
l92 <- filter(estimates, study == "laeufer1992")
...
l92_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./english-ve-meta/data/cache/l92_bm.Rdata"
)
```

```{r ko2018}
k18 <- filter(estimates, study == "ko2018")
...
k18_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./english-ve-meta/data/cache/k18_bm.Rdata"
)
```
...
meta_bm <- brm(
  ...
  seed = 9899,
  file = "./english-ve-meta/data/cache/meta_bm.Rdata"
)
```
...
meta_bm_2 <- brm(
  ...
  control = list(adapt_delta = 0.999),
  seed = 9899,
  file = "./english-ve-meta/data/cache/meta_bm_2.Rdata"
)
```
