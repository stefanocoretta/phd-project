...
meta_bm_3 <- brm(
  Estimate | se(`Est.Error`) ~ (1 | study),
  data = filter(estimated_tbl, study %in% c("petersonlehiste60", "klatt73", "davis89")),
  prior = priors,
  control = list(adapt_delta = 0.999),
  seed = 9899,
...
estimated_tbl %>%
  ...
  geom_vline(aes(xintercept = 35.24), colour = "skyblue4", linetype = "dashed") +
  geom_vline(aes(xintercept = 89.25), colour = "skyblue4", linetype = "dashed") +
  geom_vline(aes(xintercept = 61.92), colour = "skyblue4") +
  geom_point(size = 2) +
...
bind_rows(estimated_tbl, studies_shrink) %>%
  ...
  geom_hline(aes(yintercept = 35.24), colour = "skyblue4", linetype = "dashed") +
  geom_hline(aes(yintercept = 89.25), colour = "skyblue4", linetype = "dashed") +
  geom_hline(aes(yintercept = 61.92), colour = "skyblue4") +
  ...
  scale_x_discrete(labels = c("Davis (1989)", "Klatt (1973) disyllabic", "Ko (2018)", "Sharf (1962) disyllabic", "Sharf (1962) monosyllabic", "Klatt (1973) monosyllabic", "Heffner (1937)", "Laeufer (1992)", "House & Fairbanks (1953)", "Peterson & Lehiste (1960)", "Chen (1970)")) +
