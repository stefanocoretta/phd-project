...
vowel duration as a covariate of consonantal voicing.
...
the articulation of the vowel. Adapting the reasoning of the proposal by
Halle and Stevens (1967, see \Cref{s:intro}), a possible cause for the
...
millisecond increase in the degree to which voicing effects vowel
duration.
