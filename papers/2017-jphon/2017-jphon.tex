...
to revisit the problem of finding a source for the voicing effect which
concerns supra-glottal properties of stops, and in relation to which
speakers can diverge in their behaviour. As evinced by the data
presented here, tongue root advancement is an ideal candidate.

The requirement of involving a supra-glottal gesture is
straightforwardly met by tongue root advancement, which is related to an
oral articulator. As for the requisite of being speaker dependent, the
results of this study show that speakers can adopt or not tongue root
advancement, but if they do, they do so in such a way that the root in
voiced stops is already advanced at the onset of the consonant closure.
This observation can only be interpreted as an indication that the
advancement of the root is initiated before the closure onset, which
means that it is implemented even during the articulation of the vowel
preceding the consonant.

Adapting the reasoning of the proposal by Halle and Stevens (1967, see
\Cref{s:intro}), a plausible cause for the longer duration of vowels
before voiced consonants could therefore be the additional time required
to achieve a complex consonantal gesture in voiced stops that also
involves adjustments of the tongue root.
