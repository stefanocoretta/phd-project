...
data of this study. It is worth noticing that the voicing effect is
stronger in one of the Polish speakers, PL05, who has a higher random
slope estimate compared to the other Polish speakers
(\Cref{f:polish-re}). Incidentally, PL05 is also the only Polish speaker
who produced voiced consonants with an advanced tongue root, both at C2
...
average of 26 excluding IT04), although a bigger and more balanced
sample is needed to for confirmation.
