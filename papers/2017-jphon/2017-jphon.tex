...
For this study ultrasonic tongue imaging data were recorded from
speakers of Italian and Polish, two languages that have been reported to
have and lack the voicing effect respectively. In an investigation of
the general properties of segmental durations of Italian,
...
\citealt[26]{farnetani1986}). \citet{esposito2002} extends Farnetani's
...
Polish, although a difference of 2 milliseconds in vowel duration can be
observed (167.5 ms in /rata/, 169.5 ms in /rada/), such difference has
been deemed as non-significant according to statistical testing
...
\citep{van-rij2017}, while visual inspection of the difference smooth
was employed to localise the portion along which the contours diverge if
model comparison indicated a significant difference, as suggested in
\citet{soskuthy2017}. A first-order autoregressive model was used to
correct for the high autocorrelation of the residuals in GAMMs.
...
\Cref{t:lmer-italian} for a summary of the fixed effects). For Polish,
the same model structure was used, to the exclusion of the
...
\Cref{t:lmer-polish} for a summary of the fixed effects). The inspection
...
outcome variable; \textsc{voicing}, \textsc{vowel identity}, and
\textsc{place} of articulation as parametric terms. The following
smooths were specified: a \textsc{reference smooth} term for the
\textsc{x-coordinates}, three \textsc{difference smooths} for the
x-coordinates by \textsc{voicing}, \textsc{vowel identity}, and
...
the model results from IT01 and
PL05.\footnote{Although the confidence interval of the difference smooth does not include 0 in the velar region for PL05, model comparison confirms that the difference shown in the picture is non-significant.}
...
\item
  ...
  in Italian and 8 milliseconds longer in Polish.
\item
...
The data and code used in the statistical analysis of this work are
available at XXX. We obtained written consent from the participants in
this study, who agreed to make their data publicly available.

\section*{Acknowledgements}

I am extremely grateful to the participants of this study who patiently
wore the equipment for several minutes. I would like to thank Dr Ricardo
Bermúdez-Otero and Dr Patrycja Strycharczuk for their invaluable input
on both content and form of this research. I also wish to thank all the
graduate members of the University of Manchester Phonetics Lab for their
crucial support and writing assistance, and the participants of the
Ultrafest VIII conference for their influential feedback. Any errors are
still my own. This work was supported by the School of Arts, Cultures
and Humanities of the University of Manchester, UK.
