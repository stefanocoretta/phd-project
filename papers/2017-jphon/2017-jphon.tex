...
Polish. This was not born out by the data presented here. The results of
this study rather indicate that tongue root advancement in voiced stops
correlates with the voicing effect in a more complex way than initially
thought.
...
speaker-specific behaviour. As evinced from the data presented here,
...
the presence of the voicing effect or its absence thereof, but it is
rather correlated with vowel duration in a unexpected way. More
