...
As for the second requisite, the results of this study show that speakers can adopt or not tongue root advancement, but if they do, they do so in such a way that the root in voiced stops is already advanced at the onset of the consonant closure.
...
Such gestural timing account is intended as diachronic source of the voicing effect as a property of languages, rather than as a mechanic condition by which the voicing effect should be observed synchronically.
This is especially true if one considers that one speaker of Italian did not produced voiced consonants with tongue root advancement, while still having a relatively strong voicing effect.
