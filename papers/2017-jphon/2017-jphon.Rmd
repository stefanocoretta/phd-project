...
The results indicate that tongue root advancement in voiced stops indeed correlates with the presence of the VE, although the details of such correlation differ from what was expected.
...
The hypothesis that voiced consonants should not have tongue root advancement in Polish rests on the notion that Polish has been reported as a non-voicing-effect language, which was not corroborated by our data.
...
All things considered, the following implicational statement can be inferred: if a speaker realises voiced consonants with concomitant advancement of the tongue root, other things being equal, then that same same speaker will also show a considerable durational difference in vowels, with longer vowels preceding voiced consonants.
...
Having demonstrated that tongue root advancement in voiced stops is associated with a relatively stronger voicing effect, it is now possible to revisit the question of which is the source of the voicing effect.
...
The most straightforward interpretation is that the advancement of the root is initiated before the closure onset is achieved.
What this implies is that the advancement gesture is implemented even during the articulation of the vowel.
...
As we saw earlier in this section, the presence of tongue root advancement in the Polish speaker PL05 was accompanied by an 8 millisecond increase in the degree to which voicing effects vowel duration.

This thresholding aspect, coupled with the gradient hypothesis explored above, points to a potentially more complex nature of the voicing effect that is worth investigating.
