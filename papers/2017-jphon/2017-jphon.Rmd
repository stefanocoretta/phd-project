...
P-values were obtained with `lmerTest` [] which employs Satterthwaite approximations to degrees of freedom.
According to the full model, Italian vowels are 22 milliseconds (SE = 6) longer if followed by a voiced stop (*t*(12.7) = 3.596; p < 0.01).

For Polish, the same model structure was used, excluding the voicing-vowel interaction (which was not significant).
Contrary to previous findings, the model reveals a significant 8 milliseconds (SE = 3) effect of consonantal voicing on the preceding vowel (*t*(6.86) = 2.418, p < 0.05).
