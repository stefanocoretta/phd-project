...
The smaller effect of voicing in PL05 compared to the effect in Italian (14 vs 22 milliseconds) suggests that the relationship between tongue root advancement and vowel duration could be gradual, rather then categorical.
...
In addition to tongue root advancement, the ultrasonic data showed raising of the tongue body.
The presence of such gesture, although unexpected, makes sense from an anatomical point of view.
...
An alternative account ascribes tongue body raising to aerodynamic properties of voiced stops.
