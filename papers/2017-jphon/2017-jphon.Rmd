...
To test for the putative correlation between vowel duration and tongue root advancement, acoustic and ultrasound tongue imaging data were collected from eight speakers of Italian and Polish, a voicing-effect and a non-voicing-effect language respectively.
...
%Previous research points to accounts that allow for a language-specific implementation of the voicing effect and that place its source in supra-glottal articulatory properties of voiced or voiceless stops.
\end{abstract}
