...
Spline curves were then fitted to the visible contours using the AAA batch tracking function.
...
Tongue contours were exported in Cartesian coordinates at two time points: (1) at the onset of C2 closure, and (2) at maximum tongue displacement (within C2 closure).
...
Durational measurements were subject to linear mixed effects models using `lme4` in R [@r-core-team2017; @bates2015].
