...
Contrary to previous findings, the model reveals a significant 8 milliseconds (SE = 3) effect of consonantal voicing on the preceding vowel ($\chi^2$(1) = 5.4, p < 0.05).
