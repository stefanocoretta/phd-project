...
According to the full model as specified above, Italian vowels are 22 milliseconds longer (se = 6) if followed by a voiced stop ($\chi\^2$ = 16.61; p < 0.001; df = 3; see \Cref{t:lmer-italian} for a summary of the fixed effects).
...
Contrary to previous findings, the model reveals an 8 millisecond effect (se = 3) of consonantal voicing on the preceding vowel ($\chi\^2$ = 5.4; p < 0.05; df = 1; see \Cref{t:lmer-polish} for a summary of the fixed effects).
