...
Based on data from Korean, they further show that tongue root advancement not only favours voicing in stops, but it also facilitates short lag VOT in the Korean tense stops.
The established link between voicing and tongue root advancement on one hand, and between voicing and vowel duration on the other, raise the question of whether there a correlation exists between tongue root advancement and vowel duration.
...
In this study I focus on two languages, Italian and Polish, that have been reported to have and lack the voicing effect respectively.
In a study investigating the general properties of segmental durations of Italian, @farnetani1986 show that the first vowel in /lada/ is on average 35 milliseconds longer than the vowel in /lata/ (/lata/ 223 msec, sd = 18; /lada/ 258 msec, sd = 13, p. 26).
