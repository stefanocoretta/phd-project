...
An extensive pool of studies shows that vowels tend to be longer when followed by voiced obstruents and shorter when followed by voiceless obstruents [@house1953; @chen1970; @klatt1973; @lisker1973, just to mention a few].
...
On the contrary, they claim that voiceless stops do not require any specific glottal configuration and thus the voicing of the preceding vowel can just naturally ceases at closure (or a few milliseconds after it).
