...
Based on these observations, I proposed that a possible diachronic source for the longer duration of vowels before voiced stops is the additional time required for the tongue root to reach an advanced position.
