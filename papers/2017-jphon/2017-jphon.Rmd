...
The exploration of the random coefficients for each speaker indicated that PL05 has a particularly higher coefficient for voicing, meaning that the effect of voicing is stronger in his data
Note that excluding this speaker from the model doesn't remove the effect.
