...
aaa_files <- list.files(
    path = "papers/2017-jphon/data/tongues",
...
vowels <- list.files(path = "papers/2017-jphon/data/durations",
...
```{r pl03-tra}
pl03_max <- filter(tongues, speaker == "pl03", X > -25)
...
```{r pl05-tra}
pl05_max <- filter(tongues, speaker == "pl05", X > -25)
