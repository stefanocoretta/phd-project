...
tongue root advancement. In this exploratory study of the articulatory
correlates of stop voicing, it is found that tongue root advancement---a
known mechanism that facilitates voicing during stop closure---can be
implemented not only during the closure of a stop, but even during the
production of the vowel preceding a stop. Moreover, vowel acoustic
duration turned out to be linearly correlated with degree of tongue root
advancement, such that longer vowels show greater tongue root
advancement.
...
and preceding longer vowel durations. While much is known on these topic
separately, less is known about their relation.
