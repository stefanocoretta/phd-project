...
significant. V1 duration and tongue root position at V1 offset/C2 onset
are positively correlated: The longer the vowel, the more advanced the
tongue root is at V1 offset/C2 onset (\(\hat{\beta}\) = 0.065 mm, SE =
