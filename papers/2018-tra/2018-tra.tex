...
improves fit (\(\chi\)(3) = 7.758, \emph{p} = 0.001). \Cref{f:Figure3}
...
\Cref{f:Figure3} indicates that the root advances during the production
...
vowel (\Cref{f:Figure5}) and greater advancement at V1 offset/C2 onset
