...
(F2--F4, as per \citealt{machac2009}). See \Cref{f:segmentation} for a
...
{\centering \includegraphics[width=\linewidth]{./Figure7}

}

\caption{Slope plots of mean tongue root position in voiceless and voiced stops at closure onset, by-speaker. The plot on the left has raw position values in millimetres, while the plot on the right shows standardised values (z-scores) by speaker. See text for details.}\label{f:Figure7}
\end{figure}
...
degree of individual-level differences. \Cref{f:Figure7} shows two slope
...
tongue root in voiced stops. The right plot of \Cref{f:Figure7} confirms
...
\Cref{f:Figure8} plots the speakers' mean differences, with the
...
trajectories of tongue root position. \Cref{f:Figure9} shows these
...
\bibitem[{Coretta(2018)}]{coretta2018m}
...
\bibinfo{author}{Coretta, S.} (\textbf{\bibinfo{year}{2019}}).
  ...
  {I}talian and {P}olish}} \bibinfo{howpublished}{Accepted for publication at
  Glossa}.
...
\bibinfo{author}{Hussein, L.} (\textbf{\bibinfo{year}{1994}}).
  ...
  \bibinfo{school}{Columbus, Ohio: The Ohio State University}.
...
\bibinfo{author}{Nowak, P.} (\textbf{\bibinfo{year}{2006}}).
  ...
  \bibinfo{school}{Berkeley, California: University of California, Berkeley}.
