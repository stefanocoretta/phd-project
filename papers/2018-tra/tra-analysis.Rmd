...
```{r tra-gam}
if (!file.exists("./italian-polish/analysis/cache/tra-gam.Rdata")) {
  tra_gam <- bam(
    trp ~
      c2_phonation_o +
      s(speech_rate_c) +
  ...
  save(tra_gam, tra_gam_ar, tra_gam_ar_0, file = "./italian-polish/data/cache/tra-gam.Rdata")
  
} else {
  load("./italian-polish/analysis/cache/tra-gam.Rdata")
}
...
```{r tra-gam-1}
if (!file.exists("./italian-polish/data/cache/tra-gam-1.Rdata")) {
  tra_gam_1 <- bam(
    trp ~
      s(speech_rate_c) +
      s(proportion) +
  ...
  save(tra_gam, tra_gam_ar, tra_gam_ar_0, file = "./italian-polish/data/cache/tra-gam-1.Rdata")
  
} else {
  load("./italian-polish/data/cache/tra-gam-1.Rdata")
}
```

```{r tra-gam-2}
if (!file.exists("./italian-polish/data/cache/tra-gam-2.Rdata")) {
  tra_gam_2 <- bam(
    trp ~
      s(v1_duration) +
      s(proportion) +
  ...
  save(tra_gam_2, tra_gam_ar_2, tra_gam_ar_0_2, file = "./italian-polish/data/cache/tra-gam-2.Rdata")
  
} else {
  load("./italian-polish/data/cache/tra-gam-2.Rdata")
}
