...
<!-- mention that this could mean that timing of tongue root advancement is independent from closure onset timing but that slope could be different in voiced vs. voiceless. -->
<!-- unfortunately this UTI data cannot provide an answer so need future work specifically designed for this -->
