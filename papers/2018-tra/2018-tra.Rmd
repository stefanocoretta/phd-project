...
<!-- add image -->
<!-- say how you got displacement over vowel proportion and closure onset -->
...
<!-- talk about factors, ordered factors, contrasts, thin regression splines, etc -->
<!-- method = ML, AR model -->
<!-- say that language and C2 place were not improving fit nor changing relevant estimates so not included -->
...
The effect is stronger with /a/ than with /o/ and /u/.

## Tongue rot position during V2 as a function of V1 duration
