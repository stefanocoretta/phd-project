...
A great number of studies showed that, cross-linguistically, vowels tend to be longer when followed by voiced obstruents than when they are followed by voiceless ones (see for example \citealt{house1953, peterson1960, chen1970, klatt1973, lisker1974fowler1992} for English, \citealt{farnetani1986, esposito2002} for Italian, \citealt{lampp2004, durvasula2012} for Hindi, and \citealt{hussein1994} for Arabic).
