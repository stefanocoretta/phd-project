...
\begin{textblock}{3}(0.2,0.2)
  \textcolor{lightgray}{v1.0.9000 (2019/05/27)}
\end{textblock}
\maketitle
...
see \Cref{f:egg}). \citet{herbst2017}, however, showed that this method
...
evaluates the reliability of the proposed method. \Cref{s:voicing}
