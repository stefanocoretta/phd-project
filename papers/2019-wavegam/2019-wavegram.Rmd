...
```{r surface-p, include=TRUE, fig.cap = "Fitted wavegram of modal and breathy phonation (\\Cref{s:pilot}). The horizontal lines represent the dEGG maximum (solid line) and minimum (dashed line).", fig.lp="f:", out.extra="width=\\linewidth"}
lines <- tibble(
