...
Finally, whether the timing of the VC boundary depends on modulations of the vocalic or consonantal gesture, or both, is another aspect that should be further investigated in the future (see \citealt{de-jong1991} for an example).
...
Under this scenario, it is not possible to discern which of the competing predictors is diachronically responsible for the relation, and either or both of the compensatory mechanism and laryngeal features could have had a role in generating the synchronic patterns (this kind of
