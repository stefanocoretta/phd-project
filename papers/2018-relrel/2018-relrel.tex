...
ms.\footnote{The higher estimates of these studies could be related to Type M (magnitude) errors due to low statistical power, see \citealt{kirby2018}.}
Furthermore, the effect of voicing on the duration of Italian /u/ is
smaller than with /a/ and /o/ (about 3 vs.~16 ms respectively). No
effect of voicing on the duration of /u/ has been reported by
\citealt{ferrero1978}. While it is not clear why the duration of this
particular vowel should not be affected by C2 voicing, the data reported
here indicate that the magnitude of the difference in closure duration
when the preceding vowel is /u/ is smaller than with /a/ and /o/ (about
7 vs.~17 ms respectively). If vowel duration compensates for closure
duration, then a smaller difference in closure duration should
correspond to a small difference in vowel duration, as the estimates
seem to suggest.
...
a longer vowel. \Cref{f:compensatory} illustrates this mechanism.
