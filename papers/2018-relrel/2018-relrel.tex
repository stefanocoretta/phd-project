...
(see \citealt{de-jong1991} for an example).
...
cognitive sciences, see \citealt{dale2009} and references therein.
Indeed, a hybrid account, which takes into consideration and synthesises
aspects of multiple proposed accounts, is probably warranted, given the
