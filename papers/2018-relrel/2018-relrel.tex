...
see \citealt[Section V]{begus2017}, and \Cref{s:comp} of this paper).
...
CVCV words (see Figure 6 in \citealt{tilsen2013}). The stability of the
temporal distance between vowels in Italian is preliminarily supported
by the acoustic data in \citet{celata2014}. While beyond the scope of
this paper, articulatory work on the gestural coordination of sequences
besides the traditional syllable might reveal a principled organisation,
that results in the temporal patterns observed in this study and in
...
when included in the model discussed in section \Cref{s:vcduration},
