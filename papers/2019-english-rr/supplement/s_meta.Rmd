...
The following lines are the summary of the meta-analytical model obtained with the `summary()` function in R.
...
\Cref{f:intervals} shows a variety of credible intervals of the estimates from the model.
...
```{r intervals, include=TRUE, fig.cap = "", fig.lp="f:", out.extra="width=\\linewidth"}
...
This indicates that the estimate probably suffers from publication bias (i.e. bias towards publicating positive and significant results).
