...
latter have shorter closure durations. \citet{coretta2018j} reviews some
...
\citep{lindblom1967, farnetani1986} and the word
\citep{slis1969, slis1969a, lehiste1970a, lehiste1970} have been
...
words where the second consonant is voiced (for example, /pada/).
\citet{coretta2018j} argues that the temporal stability of the
...
and that the temporal stability of the release-to-release interval
offers a resolution to the drawbacks of previous versions of the
account.
...
\citep{lisker1957, van-summers1987, davis1989, de-jong1991}.
\citet{coretta2018j} thus proposes that the diachronic path to the
voicing effect in disyllabic words can be seen in the temporal stability
of the release-to-release interval and in the relative timing of the VC
boundary within that interval.

As argued in \citet{coretta2018j}, the release-to-release interval in
...
acoustic duration of vowels, hence the scope of compensation can (but
...
Sample size and a stopping rule were determined prior to data collection
with the method of the Region Of Practical Equivalence (ROPE,
\citealt{kruschke2015, vasishth2018a}). A `no-effect' region of values
...
\Cref{f:clos-5-intervals} for the posteriors and credible intervals of
...
and SD 2.84 (95\% CI = {[}−2.70, 8.19{]}). Note that the 95\% CIs of the
...
would not be affected by C2 voicing in disyllabic words but it would in
...
disyllabic words in English is very similar independent of whether C2 is
voiceless (like in /tɑːpəs/) or voiced C2 (/tɑːbəs/). On the other hand,
