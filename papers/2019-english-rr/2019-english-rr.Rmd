...
\Cref{s:gen-disc} synthesises and links these findings back to the articulatory grounding of the temporal properties of the release-to-release interval in mono- and disyllabic words expounded in \Cref{s:intro}, and discusses limitations and future work.
...
In sum, the results of this study indicate that the release-to-release duration of disyllabic words in English is very similar independent from whether C2 is voiceless (like in /tɑːpəs/) and or voiced C2 (/tɑːbəs/).
...
The results suggest a null effect of C2 voicing on the interval duration in disyllabic words (hypothesis 1a), with a 95% probability that the true effect is between −10 and +5 ms.
