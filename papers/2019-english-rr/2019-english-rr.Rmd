...
Based on what the posterior distribution indicates, and with the caveat that more data is needed to reach a sensible estimate precision and reduce uncertainty, we can cautiously argue for a mean effect increase in monosyllabic words by a factor of 1.3.
...
While it is not clear why the vowel should have the same duration in these contexts, this pattern suggest a possible process of /iː/ shortening in disyllabic words.
...
Behind the differential timing of the VC boundary within the release-to-release interval, several other accounts can be envisaged, like accounts relating to laryngeal and supraglottal adjustments \citep{halle1967, begus2017} + [coretta trp].

The absence of temporal stability in monosyllabic words needs to be reconciled with the presence of the voicing effect, of even greater magnitude, in this context.
A possible solution to the incongruence could be sought in diachrony \citep{blevins2004, blevins2006}, by speculating that the release-to-release interval was temporally stable even in monosyllabic words in earlier historical stages.
When a monosyllabic word historically derives from disyllabic words, it could be further conjectured that monosyllabic words have simply inherited the isochrony of the release-to-release interval and, with it, the voicing effect from their disyllabic predecessors.
...
While differences in the magnitude of the voicing effect should be replicated in future studies, the potentially greater effect of voicing in monosyllabic words could be ascribed to the mechanisms discussed.
