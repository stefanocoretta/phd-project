...
For each relevant term in the models, the 95% credible intervals (CI) should be taken as a summary of the posterior distribution, and inference should be based on the posterior rather than on the point estimate (the posterior mean).
...
The posterior distribution of the C2 voicing effect on release-to-release duration is tighter than that of model 1 (95% CI = [−10.45, 5.65]) while the mean (−2.43 ms, est.e. = 4.06) is virtually unchanged (−4.43 ms, only a 2 ms difference).
...
The posterior distribution of the interaction between number of syllables and C2 voicing (95% CI = [2.65, 20.98]) suggests a positive and medium-sized coefficient (mean = 11.67 ms, est.e. = 4.71).
...
The posterior distribution of the effect of voicing on /ɑː/ has mean 13.47 ms (est.e. = 5.14) and 95% CI = [3.80, 24.36].
...
On the other hand, the effect of voicing is on average 6.75 ms greater (est.e. = 6.76, 95% CI = [−7.45, 19.55]) with the vowel /iː/.
The magnitude of the voicing effect in disyllabic vs. monosyllabic words is modulated by the identity of the vowel.
The posterior distribution for the interaction C2 voicing/number of syllables when the vowel is /ɑː/ has mean 4.07 ms (est.e. = 6.6) and 95% CI [−8.94, 17.30], indicating the possibility for a very small increase of the effect from disyllabic to monosyllabic /ɑː/-words.
The three-way interaction C2 voicing/vowel/number of syllables indicates that the effect of voicing with monosyllabic /ɜː/-words is very similar to that of monosyllabic /ɑː/-words (mean = −2.66, est.e. = 9,44, 95% CI = [−21.57, 16.23]), while in monosyllabic /iː/-words it increases by 14.5 ms (est.e. = 9.43, CI = [−4.27, 33.41]).
