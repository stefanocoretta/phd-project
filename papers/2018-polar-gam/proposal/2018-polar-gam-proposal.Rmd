...
\begin{center}
\textbf{Assessing midsagittal tongue contours in polar coordinates using generalised additive (mixed) models}
\end{center}
...
More recently, @mielke2015 and @heyne2015a showed that fitting SSANOVA with tongue data using polar coordinates (rather than cartesian coordinates) produces more reliable results, and this has now become a standard.
The implementation of polar SSANOVA modelling of tongue contours has undoubtedly advanced our understanding of tongue articulation and speech.
...
This paper will offer a review of GAMMs fitted to tongue contours in polar coordinates, as an alternative to polar SSANOVA, given the increasing popularity of these models among linguists.
