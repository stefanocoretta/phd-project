...
\hypersetup{unicode=true,
            pdftitle={Assessing mid-saggital tongue contours in polar coordinates using generalised additive (mixed) models},
...
\texttt{plot\_polar\_smooths()} is shown in \Cref{f:it01-gam-plot}. For
...
speakers. \Cref{f:tongues-it01} to \Cref{f:tongues-pl07} show an
