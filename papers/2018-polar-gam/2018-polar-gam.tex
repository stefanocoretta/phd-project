...
\texttt{plot\_polar\_smooths()} is shown in \Cref{f:Figure3}. For more
...
part is significant. \Cref{f:Figure4} illustrates the use of difference
...
in \Cref{f:Figure3}, we can argue that, in the context of coronal
