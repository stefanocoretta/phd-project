...
This issue is illustrated in \Cref{f:Figure01}. The \emph{x} and
...
\emph{y} values of those points. \Cref{f:Figure02} shows a more
...
\texttt{plot\_polar\_smooths()} is shown in \Cref{f:Figure03}. For more
...
part is significant. \Cref{f:Figure04} illustrates the use of difference
...
in \Cref{f:Figure03}, we can argue that, in the context of coronal
...
autocorrelation at lag 1. \Cref{f:Figure05} show the autocorrelations in
...
speakers. \Cref{f:Figure06} to \Cref{f:Figure17} show an appreciable
