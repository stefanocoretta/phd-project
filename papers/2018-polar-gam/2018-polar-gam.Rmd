...
The contours tend to have increasing slope at the two ends, in certain cases tending to become almost completely vertical.
...
Having shown the benefits of using GAMMs with dynamic data and polar coordinates, polar GAMMs for modelling tongue contours is introduced here. Polar GAMMs are simply GAMMs fitted to tongue contours using polar coordinates.
