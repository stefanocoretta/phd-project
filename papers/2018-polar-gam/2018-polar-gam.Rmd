...
Given these estimates, it can be argued that a 2 mm change in the mid-sagittal plane contributes to an appreciable volume increase, also considering that other volume expansion mechanisms can operate along with the advancement of the tongue root (like larynx lowering, slack oral walls, etc.).
