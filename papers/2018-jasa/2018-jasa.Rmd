...
<!-- say no filer to keep the experiment short for discomfort from headset -->
...
<!-- say about told them to speak naturally and without pauses -->
These were presented on the computer screen in a randomised order across participants, although the order was kept the same for each repetition within participant due to design constraints of the AAA software.
<!-- say grand total -->
...
Offsetting and rotation relative to the participant’s occlusal plane were applied on the contour coordinates, such that the bite plate trace is aligned horizontally and the origin (0, 0) of the coordinate system corresponds to the left edge of the trace [@scobbie2011].

### Statistical analysis

The acoustic durational data were subject to linear mixed-effects regressions.
...
Significance testing in GAMMs was achieved through model comparison with the `compareML()` function from the `itsadug` package [@van-rij2017], while visual inspection of the difference smooth was employed to localise the portion along which the contours diverge if model comparison indicated a significant difference, as suggested in \citet{soskuthy2017}.
<!-- maybe I don't look at the difference smooth at all -->
