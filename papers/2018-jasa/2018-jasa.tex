...
\citep[step-down approach,][]{diggle2002, zuur2009}. All \texttt{lmer}
models were fitted using maximum likelihood estimation
(\texttt{REML\ =\ FALSE}) and treatment contrasts for factors. Bayes
...
voicing on duration is \texttt{0}). The BIC approximation was used to
calculate the Bayes factors \citep{wagenmakers2007}. The approximation
is performed according to the equation in \ref{eq:bayes}
\citep[p.~796]{wagenmakers2007}. Interpretation of the Bayes factors
will follow the recommendations in \citet[p.~139]{raftery1995}.
