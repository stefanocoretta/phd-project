...
Bayes factors \citep{wagenmakers2007}. The approximation is calculated
...
The following full and null models were fitted to test whether C2
voicing affects word duration. In the full model, I entered as fixed
effects: C2 voicing, C2 place, vowel, speech rate, and language. The
model also included by-speaker and by-word random intercepts, plus a
...
more likely than the full model given the data. This indicates that
there is strong evidence for word duration not being affected by C2
voicing.
