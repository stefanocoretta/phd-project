...
from the fact that C1 is held constant---or the motor plan for CV́CV
...
the results in \citet{maddieson1976}. A drawback of the analysis in
...
taken into account, and not the entire \emph{consonant} duration. If the
