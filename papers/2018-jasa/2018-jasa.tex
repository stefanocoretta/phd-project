...
disyllabic (CV́CV) words in Italian and Polish. Given its exploratory
nature, this study was not devised to test the compensatory account, but
rather to collect articulatory and acoustic data on the voicing
...
put forward here, only the results from the acoustics part of the study
will be discussed.
...
voiced consonants (based on 3 speakers from \citealt{farnetani1986} and
7 speakers from \citealt{esposito2002}; \citealt{caldognetto1979} does
not report estimates.). On the other hand, the results regarding the
...
voiced stops are 4.5 ms longer in the 4 speakers recorded. Moreover,
...
Italian (4 words) and Polish (2 words, see \Cref{a:targets}). The
...
\emph{p}-values are included in \Cref{a:stats}.

\hypertarget{vowel-duration}{%
\subsection{Vowel duration}\label{vowel-duration}}

\begin{figure}
\includegraphics[width=\linewidth]{2018-jasa_files/figure-latex/vowels-plot-1} \caption{Vowel duration in Italian and Polish.}\label{f:vowels-plot}
\end{figure}
...
language and C2 voicing is deemed as not significant). Speech rate has
unsurprisingly a negative effect on vowel duration, such that faster
...
\begin{figure}
\includegraphics[width=\linewidth]{2018-jasa_files/figure-latex/closure-plot-1} \caption{Stop closure duration in Italian and Polish.}\label{f:closure-plot}
\end{figure}
...
\begin{figure}
\includegraphics[width=\linewidth]{2018-jasa_files/figure-latex/vow-clo-plot-1} \caption{Linear regression of closure and vowel duration per vowel.}\label{f:vow-clo-plot}
\end{figure}
...
\begin{figure}
\includegraphics[width=\linewidth]{2018-jasa_files/figure-latex/rr-plot-1} \caption{Release to Release interval duration.}\label{f:rr-plot}
\end{figure}
