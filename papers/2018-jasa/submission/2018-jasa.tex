...
duration was measured in seconds. \Cref{f:segmentation} shows an example
...
\begin{figure*}
  \figline{
    \fig{Figure1a.pdf}{0.5\textwidth}{(a)}
    \fig{Figure1b.pdf}{0.5\textwidth}{(b)}
  }
...
\bibitem[{Ananthapadmanabha \emph{et~al.}(2014)Ananthapadmanabha, Prathosh, and
  Ramakrishnan}]{ananthapadmanabha2014}
...
\bibitem[{{Articulate Instruments Ltd{\texttrademark}}(2011)}]{articulate2011}
...
\bibitem[{Begu{\v s}(2017)}]{begus2017}
...
\bibitem[{Belasco(1953)}]{belasco1953}
...
\bibitem[{Berez-Kroeker \emph{et~al.}(2018)Berez-Kroeker, Gawne, Kung, Kelly,
  Heston, Holton, Pulsifer, Beaver, Chelliah, and Dubinsky}]{berez-kroeker2018}
...
\bibitem[{Bigi(2015)}]{bigi2015}
\bibinfo{author}{Bigi, B.} (\textbf{\bibinfo{year}{2015}}).
  \enquote{\bibinfo{title}{{SPPAS} - {M}ulti-lingual approaches to the
  automatic annotation of speech}} \bibinfo{journal}{The Phonetician}
  \textbf{111--112}, \bibinfo{pages}{54--69}.

\bibitem[{Browman and Goldstein(1988)}]{browman1988}
\bibinfo{author}{Browman, C.~P.},  and \bibinfo{author}{Goldstein, L.}
  (\textbf{\bibinfo{year}{1988}}). \enquote{\bibinfo{title}{Some notes on
  syllable structure in articulatory phonology}} \bibinfo{journal}{Phonetica}
  \textbf{45}(2-4), \bibinfo{pages}{140--155}.

\bibitem[{Browman and Goldstein(2000)}]{browman2000}
\bibinfo{author}{Browman, C.~P.},  and \bibinfo{author}{Goldstein, L.}
  (\textbf{\bibinfo{year}{2000}}). \enquote{\bibinfo{title}{Competing
  constraints on intergestural coordination and self-organization of
  phonological structures}} \bibinfo{journal}{Bulletin de la communication
  parl{\'e}e} (5), \bibinfo{pages}{25--34}.

\bibitem[{Caldognetto \emph{et~al.}(1979)Caldognetto, Ferrero, Vagges, and
  Bagno}]{caldognetto1979}
\bibinfo{author}{Caldognetto, E.~M.}, \bibinfo{author}{Ferrero, F.},
  \bibinfo{author}{Vagges, K.},  and \bibinfo{author}{Bagno, M.}
  (\textbf{\bibinfo{year}{1979}}). \enquote{\bibinfo{title}{Indici acustici e
  indici percettivi nel riconoscimento dei suoni linguistici (con applicazione
  alle consonanti occlusive dell'italiano)}} \bibinfo{journal}{Acta Phoniatrica
  Latina} \textbf{2}, \bibinfo{pages}{219--246}.

\bibitem[{Celata \emph{et~al.}(2018)Celata, Meluzzi, and Bertini}]{celata2018}
\bibinfo{author}{Celata, C.}, \bibinfo{author}{Meluzzi, C.},  and
  \bibinfo{author}{Bertini, C.} (\textbf{\bibinfo{year}{2018}}).
  \plainquote{\bibinfo{title}{Stressed vowel durational variations and
  articulatory cohesiveness: Italian data}} \bibinfo{howpublished}{Poster
  presented at LabPhon 16, Lisbon}.

\bibitem[{Chen(1970)}]{chen1970}
\bibinfo{author}{Chen, M.} (\textbf{\bibinfo{year}{1970}}).
  \enquote{\bibinfo{title}{Vowel length variation as a function of the voicing
  of the consonant environment}} \bibinfo{journal}{Phonetica} \textbf{22}(3),
  \bibinfo{pages}{129--159}.

\bibitem[{Coretta(2018)}]{coretta2018g}
\bibinfo{author}{Coretta, S.} (\textbf{\bibinfo{year}{2018}}).
  \plainquote{\bibinfo{title}{An exploratory study of voicing-related
  differences in vowel duration as compensatory temporal adjustment in
  {I}talian and {P}olish [{R}esearch compendium]}} \bibinfo{howpublished}{Open
  Science Framework},
  \dourl{https://osf.io/bfyhr/?view_only=391ef2dcc2834039a90f739ddb6f137a}.

\bibitem[{Cysouw and Good(2013)}]{cysouw2013}
\bibinfo{author}{Cysouw, M.},  and \bibinfo{author}{Good, J.}
  (\textbf{\bibinfo{year}{2013}}). \enquote{\bibinfo{title}{Languoid, doculect,
  and glossonym: {F}ormalizing the notion `language'}}
  \bibinfo{journal}{Language Documentation \& Conservation} \textbf{7},
  \bibinfo{pages}{331--359}, \dodoi{10125/4606}.

\bibitem[{Davis and Van~Summers(1989)}]{davis1989}
\bibinfo{author}{Davis, S.},  and \bibinfo{author}{Van~Summers, W.}
  (\textbf{\bibinfo{year}{1989}}). \enquote{\bibinfo{title}{Vowel length and
  closure duration in word-medial {VC} sequences}} \bibinfo{journal}{The
  Journal of the Acoustical Society of America} \textbf{17},
  \bibinfo{pages}{339--353}, \dodoi{10.1121/1.2026892}.

\bibitem[{De~Jong(1991)}]{de-jong1991}
\bibinfo{author}{De~Jong, K.} (\textbf{\bibinfo{year}{1991}}).
  \enquote{\bibinfo{title}{An articulatory study of consonant-induced vowel
  duration changes in english}} \bibinfo{journal}{Phonetica} \textbf{48}(1),
  \bibinfo{pages}{1--17}, \dodoi{10.1121/1.2028316}.

\bibitem[{Durvasula and Luo(2012)}]{durvasula2012}
\bibinfo{author}{Durvasula, K.},  and \bibinfo{author}{Luo, Q.}
  (\textbf{\bibinfo{year}{2012}}). \enquote{\bibinfo{title}{Voicing,
  aspiration, and vowel duration in {H}indi}} \bibinfo{journal}{Proceedings of
  Meetings on Acoustics} \textbf{18}, \bibinfo{pages}{1--10},
  \dodoi{10.1121/1.4895027}.

\bibitem[{Esposito(2002)}]{esposito2002}
\bibinfo{author}{Esposito, A.} (\textbf{\bibinfo{year}{2002}}).
  \enquote{\bibinfo{title}{On vowel height and consonantal voicing effects:
  Data from {I}talian}} \bibinfo{journal}{Phonetica} \textbf{59}(4),
  \bibinfo{pages}{197--231}, \dodoi{10.1159/000068347}.

\bibitem[{Farnetani and Kori(1986)}]{farnetani1986}
\bibinfo{author}{Farnetani, E.},  and \bibinfo{author}{Kori, S.}
  (\textbf{\bibinfo{year}{1986}}). \enquote{\bibinfo{title}{Effects of syllable
  and word structure on segmental durations in spoken {I}talian}}
  \bibinfo{journal}{Speech communication} \textbf{5}(1),
  \bibinfo{pages}{17--34}, \dodoi{10.1016/0167-6393(86)90027-0}.

\bibitem[{Ferrero \emph{et~al.}(1978)Ferrero, Magno-Caldognetto, Vagges, and
  Lavagnoli}]{ferrero1978}
\bibinfo{author}{Ferrero, F.~E.}, \bibinfo{author}{Magno-Caldognetto, E.},
  \bibinfo{author}{Vagges, K.},  and \bibinfo{author}{Lavagnoli, C.}
  (\textbf{\bibinfo{year}{1978}}). \enquote{\bibinfo{title}{Some acoustic
  characteristics of {I}talian vowels}} \bibinfo{journal}{Journal of Italian
  Linguistics Amsterdam} \textbf{3}(1), \bibinfo{pages}{87--94}.

\bibitem[{Fowler(1992)}]{fowler1992}
\bibinfo{author}{Fowler, C.~A.} (\textbf{\bibinfo{year}{1992}}).
  \enquote{\bibinfo{title}{Vowel duration and closure duration in voiced and
  unvoiced stops: {T}here are no contrast effects here}}
  \bibinfo{journal}{Journal of Phonetics} \textbf{20}(1),
  \bibinfo{pages}{143--165}.

\bibitem[{Fox(2003)}]{fox2003}
\bibinfo{author}{Fox, J.} (\textbf{\bibinfo{year}{2003}}).
  \enquote{\bibinfo{title}{Effect displays in {R} for generalised linear
  models}} \bibinfo{journal}{ournal of Statistical Software} \textbf{8}(15),
  \bibinfo{pages}{1--27}, \dodoi{10.18637/jss.v008.i15}.

\bibitem[{Gelman and Loken(2013)}]{gelman2013}
\bibinfo{author}{Gelman, A.},  and \bibinfo{author}{Loken, E.}
  (\textbf{\bibinfo{year}{2013}}). \plainquote{\bibinfo{title}{The garden of
  forking paths: Why multiple comparisons can be a problem, even when there is
  no ``fishing expedition'' or ``p-hacking''and the research hypothesis was
  posited ahead of time}} \bibinfo{howpublished}{Department of Statistics,
  Columbia University,
  \url{http://www.stat.columbia.edu/~gelman/research/unpublished/p_hacking.pdf}}.

\bibitem[{Goldstein \emph{et~al.}(2006)Goldstein, Byrd, and
  Saltzman}]{goldstein2006}
\bibinfo{author}{Goldstein, L.}, \bibinfo{author}{Byrd, D.},  and
  \bibinfo{author}{Saltzman, E.} (\textbf{\bibinfo{year}{2006}}).
  \enquote{\bibinfo{title}{The role of vocal tract gestural action units in
  understanding the evolution of phonology}} in
  \emph{\bibinfo{booktitle}{Action to Language via the Mirror Neuron System}},
  edited by \bibinfo{editor}{M.~A. Arbib} (\bibinfo{publisher}{Cambridge:
  Cambridge University Press}), pp. \bibinfo{pages}{215--249}.

\bibitem[{Goldstein and Pouplier(2014)}]{goldstein2014}
\bibinfo{author}{Goldstein, L.},  and \bibinfo{author}{Pouplier, M.}
  (\textbf{\bibinfo{year}{2014}}). \enquote{\bibinfo{title}{The temporal
  organization of speech}} in \emph{\bibinfo{booktitle}{The Oxford handbook of
  language production}}, edited by \bibinfo{editor}{V.~Ferreira},
  \bibinfo{editor}{M.~Goldrick}, and \bibinfo{editor}{M.~Miozzo}
  (\bibinfo{publisher}{Oxford: Oxford University Press}).

\bibitem[{Gussmann(2007)}]{gussmann2007}
\bibinfo{author}{Gussmann, E.} (\textbf{\bibinfo{year}{2007}}).
  \emph{\bibinfo{title}{The phonology of {P}olish}} (\bibinfo{publisher}{Oxford
  University Press}).

\bibitem[{Hajek and Stevens(2008)}]{hajek2008}
\bibinfo{author}{Hajek, J.},  and \bibinfo{author}{Stevens, M.}
  (\textbf{\bibinfo{year}{2008}}). \enquote{\bibinfo{title}{Vowel duration,
  compression and lengthening in stressed syllables in central and southern
  varieties of standard italian}} \bibinfo{publisher}{ISCA}.

\bibitem[{Halle and Stevens(1967)}]{halle1967}
\bibinfo{author}{Halle, M.},  and \bibinfo{author}{Stevens, K.}
  (\textbf{\bibinfo{year}{1967}}). \enquote{\bibinfo{title}{Mechanism of
  glottal vibration for vowels and consonants}} \bibinfo{journal}{The Journal
  of the Acoustical Society of America} \textbf{41}(6),
  \bibinfo{pages}{1613--1613}, \dodoi{10.1121/1.2143736}.

\bibitem[{Heffner(1937)}]{heffner1937}
\bibinfo{author}{Heffner, R.-M.} (\textbf{\bibinfo{year}{1937}}).
  \enquote{\bibinfo{title}{Notes on the length of vowels}}
  \bibinfo{journal}{American Speech} \textbf{12}, \bibinfo{pages}{128--134},
  \dodoi{10.2307/452621}.

\bibitem[{Hertrich and Ackermann(1997)}]{hertrich1997}
\bibinfo{author}{Hertrich, I.},  and \bibinfo{author}{Ackermann, H.}
  (\textbf{\bibinfo{year}{1997}}). \enquote{\bibinfo{title}{Articulatory
  control of phonological vowel length contrasts: {K}inematic analysis of
  labial gestures}} \bibinfo{journal}{The Journal of the Acoustical Society of
  America} \textbf{102}(1), \bibinfo{pages}{523--536},
  \dodoi{10.1121/1.419725}.

\bibitem[{Hirsch(2014)}]{hirsch2014}
\bibinfo{author}{Hirsch, A.} (\textbf{\bibinfo{year}{2014}}).
  \enquote{\bibinfo{title}{What is the domain for weight computation: the
  syllable or the interval?}} in \emph{\bibinfo{booktitle}{Proceedings of the
  {A}nnual {M}eetings on {P}honology}}.

\bibitem[{House and Fairbanks(1953)}]{house1953}
\bibinfo{author}{House, A.~S.},  and \bibinfo{author}{Fairbanks, G.}
  (\textbf{\bibinfo{year}{1953}}). \enquote{\bibinfo{title}{The influence of
  consonant environment upon the secondary acoustical characteristics of
  vowels}} \bibinfo{journal}{The Journal of the Acoustical Society of America}
  \textbf{25}(1), \bibinfo{pages}{105--113}, \dodoi{10.1121/1.1906982}.

\bibitem[{Hussein(1994)}]{hussein1994}
\bibinfo{author}{Hussein, L.} (\textbf{\bibinfo{year}{1994}}).
  \enquote{\bibinfo{title}{Voicing-dependent vowel duration in {S}tandard
  {A}rabic and its acquisition by adult american students}} Ph.D. thesis,
  \bibinfo{school}{The Ohio State University}.

\bibitem[{Jacewicz \emph{et~al.}(2009)Jacewicz, Fox, and Lyle}]{jacewicz2009}
\bibinfo{author}{Jacewicz, E.}, \bibinfo{author}{Fox, R.~A.},  and
  \bibinfo{author}{Lyle, S.} (\textbf{\bibinfo{year}{2009}}).
  \enquote{\bibinfo{title}{Variation in stop consonant voicing in two regional
  varieties of {A}merican {E}nglish}} \bibinfo{journal}{Journal of the
  International Phonetic Association} \textbf{39}(3),
  \bibinfo{pages}{313--334}, \dodoi{10.1017/S0025100309990156}.

\bibitem[{Jarosz and Wiley(2014)}]{jarosz2014}
\bibinfo{author}{Jarosz, A.~F.},  and \bibinfo{author}{Wiley, J.}
  (\textbf{\bibinfo{year}{2014}}). \enquote{\bibinfo{title}{What are the odds?
  {A} practical guide to computing and reporting {B}ayes factors}}
  \bibinfo{journal}{The Journal of Problem Solving} \textbf{7}(1),
  \bibinfo{pages}{2--9}, \dodoi{10.7771/1932-6246.1167}.

\bibitem[{Javkin(1976)}]{javkin1976}
\bibinfo{author}{Javkin, H.~R.} (\textbf{\bibinfo{year}{1976}}).
  \enquote{\bibinfo{title}{The perceptual basis of vowel duration differences
  associated with the voiced/voiceless distinction}} \bibinfo{journal}{Report
  of the Phonology Laboratory, UC Berkeley} \textbf{1},
  \bibinfo{pages}{78--92}.

\bibitem[{Keating(1984)}]{keating1984}
\bibinfo{author}{Keating, P.~A.} (\textbf{\bibinfo{year}{1984}}).
  \enquote{\bibinfo{title}{Universal phonetics and the organization of
  grammars}} \bibinfo{journal}{{UCLA Working Papers in Phonetics}} \textbf{59}.

\bibitem[{Kerr(1998)}]{kerr1998}
\bibinfo{author}{Kerr, N.~L.} (\textbf{\bibinfo{year}{1998}}).
  \enquote{\bibinfo{title}{{HARKing}: Hypothesizing after the results are
  known}} \bibinfo{journal}{Personality and Social Psychology Review}
  \textbf{2}(3), \bibinfo{pages}{196--217},
  \dodoi{10.1207/s15327957pspr0203_4}.

\bibitem[{Klatt(1973)}]{klatt1973}
\bibinfo{author}{Klatt, D.~H.} (\textbf{\bibinfo{year}{1973}}).
  \enquote{\bibinfo{title}{Interaction between two factors that influence vowel
  duration}} \bibinfo{journal}{The Journal of the Acoustical Society of
  America} \textbf{54}(4), \bibinfo{pages}{1102--1104},
  \dodoi{10.1121/1.1914322}.

\bibitem[{Kluender \emph{et~al.}(1988)Kluender, Diehl, and
  Wright}]{kluender1988}
\bibinfo{author}{Kluender, K.~R.}, \bibinfo{author}{Diehl, R.~L.},  and
  \bibinfo{author}{Wright, B.~A.} (\textbf{\bibinfo{year}{1988}}).
  \enquote{\bibinfo{title}{Vowel-length differences before voiced and voiceless
  consonants: {A}n auditory explanation}} \bibinfo{journal}{Journal of
  Phonetics} \textbf{16}, \bibinfo{pages}{153--169}.

\bibitem[{Kr{\"a}mer(2009)}]{kramer2009}
\bibinfo{author}{Kr{\"a}mer, M.} (\textbf{\bibinfo{year}{2009}}).
  \emph{\bibinfo{title}{The phonology of {I}talian}}
  (\bibinfo{publisher}{Oxford: Oxford University Press}).

\bibitem[{Kuznetsova \emph{et~al.}(2017)Kuznetsova, {Bruun Brockhoff}, and
  {Haubo Bojesen Christensen}}]{kuznetsova2017}
\bibinfo{author}{Kuznetsova, A.}, \bibinfo{author}{{Bruun Brockhoff}, P.},  and
  \bibinfo{author}{{Haubo Bojesen Christensen}, R.}
  (\textbf{\bibinfo{year}{2017}}). \enquote{\bibinfo{title}{\texttt{lmerTest}
  package: Tests in linear mixed effects models}} \bibinfo{journal}{Journal of
  Statistical Software} \textbf{82}(13), \dodoi{10.18637/jss.v082.i13}.

\bibitem[{Laeufer(1992)}]{laeufer1992}
\bibinfo{author}{Laeufer, C.} (\textbf{\bibinfo{year}{1992}}).
  \enquote{\bibinfo{title}{Patterns of voicing-conditioned vowel duration in
  {F}rench and {E}nglish}} \bibinfo{journal}{Journal of Phonetics}
  \textbf{20}(4), \bibinfo{pages}{411--440}.

\bibitem[{Lampp and Reklis(2004)}]{lampp2004}
\bibinfo{author}{Lampp, C.},  and \bibinfo{author}{Reklis, H.}
  (\textbf{\bibinfo{year}{2004}}). \enquote{\bibinfo{title}{Effects of coda
  voicing and aspiration on {H}indi vowels}} \bibinfo{journal}{The Journal of
  the Acoustical Society of America} \textbf{115}(5),
  \bibinfo{pages}{2540--2540}, \dodoi{10.1121/1.4783577}.

\bibitem[{Lehiste(1970{\natexlab{a}})}]{lehiste1970a}
\bibinfo{author}{Lehiste, I.} (\textbf{\bibinfo{year}{1970}}{\natexlab{a}}).
  \enquote{\bibinfo{title}{Temporal organization of higher-level linguistic
  units}} \bibinfo{journal}{The Journal of the Acoustical Society of America}
  \textbf{48}(1A), \bibinfo{pages}{111--111}, \dodoi{10.1121/1.1974906}.

\bibitem[{Lehiste(1970{\natexlab{b}})}]{lehiste1970}
\bibinfo{author}{Lehiste, I.} (\textbf{\bibinfo{year}{1970}}{\natexlab{b}}).
  \enquote{\bibinfo{title}{Temporal organization of spoken language}} in
  \emph{\bibinfo{booktitle}{Working Papers in Linguistics}}, Vol. 4, pp.
  \bibinfo{pages}{96--114}, \dodoi{10.1121/1.1974906}.

\bibitem[{Lindblom(1967)}]{lindblom1967}
\bibinfo{author}{Lindblom, B.} (\textbf{\bibinfo{year}{1967}}).
  \enquote{\bibinfo{title}{Vowel duration and a model of lip mandible
  coordination}} \bibinfo{journal}{Speech Transmission Laboratory Quarterly
  Progress Status Report} \textbf{4}, \bibinfo{pages}{1--29}.

\bibitem[{Lisker(1957)}]{lisker1957}
\bibinfo{author}{Lisker, L.} (\textbf{\bibinfo{year}{1957}}).
  \enquote{\bibinfo{title}{Closure duration and the intervocalic
  voiced-voiceless distinction in {E}nglish}} \bibinfo{journal}{Language}
  \textbf{33}(1), \bibinfo{pages}{42--49}, \dodoi{10.2307/410949}.

\bibitem[{Lisker(1974)}]{lisker1974}
\bibinfo{author}{Lisker, L.} (\textbf{\bibinfo{year}{1974}}).
  \enquote{\bibinfo{title}{On ``explaining'' vowel duration variation}} in
  \emph{\bibinfo{booktitle}{Proceedings of the {L}inguistic {S}ociety of
  {A}merica}}, pp. \bibinfo{pages}{225--232}.

\bibitem[{Luke(2017)}]{luke2017}
\bibinfo{author}{Luke, S.~G.} (\textbf{\bibinfo{year}{2017}}).
  \enquote{\bibinfo{title}{Evaluating significance in linear mixed-effects
  models in {R}}} \bibinfo{journal}{Behavior Research Methods} \textbf{49}(4),
  \bibinfo{pages}{1494--1502}, \dodoi{10.3758/s13428-016-0809-y}.

\bibitem[{Lunden(2017)}]{lunden2017}
\bibinfo{author}{Lunden, A.} (\textbf{\bibinfo{year}{2017}}).
  \enquote{\bibinfo{title}{Syllable weight and duration: a rhyme/intervals
  comparison}} \bibinfo{journal}{Proceedings of the Linguistic Society of
  America} \textbf{2}, \bibinfo{pages}{33--1}, \dodoi{10.3765/plsa.v2i0.4084}.

\bibitem[{Maddieson and Gandour(1976)}]{maddieson1976}
\bibinfo{author}{Maddieson, I.},  and \bibinfo{author}{Gandour, J.}
  (\textbf{\bibinfo{year}{1976}}). \enquote{\bibinfo{title}{Vowel length before
  aspirated consonants}} in \emph{\bibinfo{booktitle}{{UCLA Working papers in
  Phonetics}}}, Vol. 31, pp. \bibinfo{pages}{46--52}.

\bibitem[{Malisz and Klessa(2008)}]{malisz2008}
\bibinfo{author}{Malisz, Z.},  and \bibinfo{author}{Klessa, K.}
  (\textbf{\bibinfo{year}{2008}}). \enquote{\bibinfo{title}{A preliminary study
  of temporal adaptation in {Polish} {VC} groups}} in
  \emph{\bibinfo{booktitle}{Proceedings of Speech Prosody}}, pp.
  \bibinfo{pages}{383--386}.

\bibitem[{Marin and Pouplier(2010)}]{marin2010}
\bibinfo{author}{Marin, S.},  and \bibinfo{author}{Pouplier, M.}
  (\textbf{\bibinfo{year}{2010}}). \enquote{\bibinfo{title}{Temporal
  organization of complex onsets and codas in {A}merican {E}nglish: Testing the
  predictions of a gestural coupling model}} \bibinfo{journal}{Motor Control}
  \textbf{14}(3), \bibinfo{pages}{380--407}.

\bibitem[{Marin and Pouplier(2014)}]{marin2014}
\bibinfo{author}{Marin, S.},  and \bibinfo{author}{Pouplier, M.}
  (\textbf{\bibinfo{year}{2014}}). \enquote{\bibinfo{title}{Articulatory
  synergies in the temporal organization of liquid clusters in {R}omanian}}
  \bibinfo{journal}{Journal of Phonetics} \textbf{42}, \bibinfo{pages}{24--36},
  \dodoi{10.1016/j.wocn.2013.11.001}.

\bibitem[{Meyer(1904)}]{meyer1904}
\bibinfo{author}{Meyer, E.~A.} (\textbf{\bibinfo{year}{1904}}).
  \enquote{\bibinfo{title}{Zur vokaldauer im deutschen}} in
  \emph{\bibinfo{booktitle}{Nordiska Studier tillegnade {A}. {N}oreen}}
  (\bibinfo{publisher}{K.W. Appelbergs Boktryckeri: Uppsala}), pp.
  \bibinfo{pages}{347--356}.

\bibitem[{Nowak(2006)}]{nowak2006}
\bibinfo{author}{Nowak, P.} (\textbf{\bibinfo{year}{2006}}).
  \enquote{\bibinfo{title}{Vowel reduction in {P}olish}} Ph.D. thesis,
  \bibinfo{school}{University of California, Berkeley}.

\bibitem[{Peterson and Lehiste(1960)}]{peterson1960}
\bibinfo{author}{Peterson, G.~E.},  and \bibinfo{author}{Lehiste, I.}
  (\textbf{\bibinfo{year}{1960}}). \enquote{\bibinfo{title}{Duration of
  syllable nuclei in {E}nglish}} \bibinfo{journal}{The Journal of the
  Acoustical Society of America} \textbf{32}(6), \bibinfo{pages}{693--703},
  \dodoi{10.1121/1.1908183}.

\bibitem[{Plug and Smith(2018)}]{plug2018}
\bibinfo{author}{Plug, L.},  and \bibinfo{author}{Smith, R.}
  (\textbf{\bibinfo{year}{2018}}). \plainquote{\bibinfo{title}{Segments,
  syllables and speech tempo perception}} \bibinfo{howpublished}{Talk presented
  at the 2018 Colloquium of the British Association of Academic Phoneticians
  (BAAP 2018)}.

\bibitem[{{R Core Team}(2018)}]{r-core-team2018}
\bibinfo{author}{{R Core Team}} (\textbf{\bibinfo{year}{2018}}).
  \plainquote{\bibinfo{title}{R: A language and environment for statistical
  computing}} \bibinfo{howpublished}{R Foundation for Statistical Computing,
  Vienna, Austria}, \dourl{https://www.R-project.org}.

\bibitem[{Raftery(1995)}]{raftery1995}
\bibinfo{author}{Raftery, A.~E.} (\textbf{\bibinfo{year}{1995}}).
  \enquote{\bibinfo{title}{Bayesian model selection in social research}}
  \bibinfo{journal}{Sociological methodology} \bibinfo{pages}{111--163},
  \dodoi{10.2307/271063}.

\bibitem[{Raftery(1999)}]{raftery1999}
\bibinfo{author}{Raftery, A.~E.} (\textbf{\bibinfo{year}{1999}}).
  \enquote{\bibinfo{title}{Bayes factors and {BIC}: Comment on ``{A} critique
  of the {B}ayesian information criterion for model selection''}}
  \bibinfo{journal}{Sociological Methods \& Research} \textbf{27}(3),
  \bibinfo{pages}{411--427}, \dodoi{10.1177/0049124199027003005}.

\bibitem[{Raphael(1975)}]{raphael1975}
\bibinfo{author}{Raphael, L.~J.} (\textbf{\bibinfo{year}{1975}}).
  \enquote{\bibinfo{title}{The physiological control of durational differences
  between vowels preceding voiced and voiceless consonants in {E}nglish}}
  \bibinfo{journal}{Journal of Phonetics} \textbf{3}(1),
  \bibinfo{pages}{25--33}.

\bibitem[{Renwick and Ladd(2016)}]{renwick2016}
\bibinfo{author}{Renwick, M.},  and \bibinfo{author}{Ladd, R.~D.}
  (\textbf{\bibinfo{year}{2016}}). \enquote{\bibinfo{title}{Phonetic
  distinctiveness vs. lexical contrastiveness in non-robust phonemic
  contrasts}} \bibinfo{journal}{Laboratory Phonology: Journal of the
  Association for Laboratory Phonology} \textbf{7}(1), \bibinfo{pages}{1--29},
  \dodoi{10.5334/labphon.17}.

\bibitem[{Roettger(2018)}]{roettger2018}
\bibinfo{author}{Roettger, T.~B.} (\textbf{\bibinfo{year}{2018}}).
  \plainquote{\bibinfo{title}{Researcher degrees of freedom in phonetic
  sciences}} \bibinfo{howpublished}{Pre-print available at PsyArXiv},
  \dodoi{10.31234/osf.io/fp4jr}.

\bibitem[{Slis and Cohen(1969{\natexlab{a}})}]{slis1969a}
\bibinfo{author}{Slis, I.~H.},  and \bibinfo{author}{Cohen, A.}
  (\textbf{\bibinfo{year}{1969}}{\natexlab{a}}). \enquote{\bibinfo{title}{On
  the complex regulating the voiced-voiceless distinction {I}}}
  \bibinfo{journal}{Language and speech} \textbf{12}(2),
  \bibinfo{pages}{80--102}, \dodoi{10.1177/002383096901200202}.

\bibitem[{Slis and Cohen(1969{\natexlab{b}})}]{slis1969}
\bibinfo{author}{Slis, I.~H.},  and \bibinfo{author}{Cohen, A.}
  (\textbf{\bibinfo{year}{1969}}{\natexlab{b}}). \enquote{\bibinfo{title}{On
  the complex regulating the voiced-voiceless distinction {II}}}
  \bibinfo{journal}{Language and speech} \textbf{12}(3),
  \bibinfo{pages}{137--155}, \dodoi{10.1177/002383096901200301}.

\bibitem[{S{\'o}skuthy(2013)}]{soskuthy2013}
\bibinfo{author}{S{\'o}skuthy, M.} (\textbf{\bibinfo{year}{2013}}).
  \enquote{\bibinfo{title}{Phonetic biases and systemic effects in the
  actuation of sound change}} Ph.D. thesis, \bibinfo{school}{University of
  Edinburgh}.

\bibitem[{Steriade(2012)}]{steriade2012}
\bibinfo{author}{Steriade, D.} (\textbf{\bibinfo{year}{2012}}).
  \plainquote{\bibinfo{title}{Intervals vs. syllables as units of linguistic
  rhythm}} \bibinfo{howpublished}{Talk presented at EALING, Paris:
  \url{http://ealing.cognition.ens.fr/ealing2012/handouts/Steriade/}}.

\bibitem[{Tilsen(2013)}]{tilsen2013}
\bibinfo{author}{Tilsen, S.} (\textbf{\bibinfo{year}{2013}}).
  \enquote{\bibinfo{title}{A dynamical model of hierarchical selection and
  coordination in speech planning}} \bibinfo{journal}{PLoS ONE} \textbf{8}(4),
  \bibinfo{pages}{e62800}, \dodoi{10.1371/ journal.pone.0062800}.

\bibitem[{Van~Summers(1987)}]{van-summers1987}
\bibinfo{author}{Van~Summers, W.} (\textbf{\bibinfo{year}{1987}}).
  \enquote{\bibinfo{title}{Effects of stress and final-consonant voicing on
  vowel production: Articulatory and acoustic analyses}} \bibinfo{journal}{The
  Journal of the Acoustical Society of America} \textbf{82}(3),
  \bibinfo{pages}{847--863}, \dodoi{10.1121/1.395284}.

\bibitem[{Vazquez-Alvarez and Hewlett(2007)}]{vazquez-alvarez2007}
\bibinfo{author}{Vazquez-Alvarez, Y.},  and \bibinfo{author}{Hewlett, N.}
  (\textbf{\bibinfo{year}{2007}}). \enquote{\bibinfo{title}{The `trough
  effect': an ultrasound study}} \bibinfo{journal}{Phonetica} \textbf{64}(2-3),
  \bibinfo{pages}{105--121}, \dodoi{10.1159/000107912}.

\bibitem[{Wagenmakers(2007)}]{wagenmakers2007}
\bibinfo{author}{Wagenmakers, E.-J.} (\textbf{\bibinfo{year}{2007}}).
  \enquote{\bibinfo{title}{A practical solution to the pervasive problems of
  \textit{p} values}} \bibinfo{journal}{Psychonomic bulletin \& review}
  \textbf{14}(5), \bibinfo{pages}{779--804}, \dodoi{10.3758/BF03194105}.

\bibitem[{Warren and Jacks(2005)}]{warren2005}
\bibinfo{author}{Warren, W.},  and \bibinfo{author}{Jacks, A.}
  (\textbf{\bibinfo{year}{2005}}). \enquote{\bibinfo{title}{Lip and jaw closing
  gesture durations in syllable final voiced and voiceless stops}}
  \bibinfo{journal}{The Journal of the Acoustical Society of America}
  \textbf{117}(4), \bibinfo{pages}{2618--2618}, \dodoi{10.1121/1.4778168}.

\bibitem[{Wickham(2017)}]{wickham2017}
\bibinfo{author}{Wickham, H.} (\textbf{\bibinfo{year}{2017}}).
  \plainquote{\bibinfo{title}{\texttt{tidyverse}: Easily install and load the
  `{T}idyverse'}} \bibinfo{howpublished}{R package version 1.2.1.},
  \dourl{https://CRAN.R-project.org/package=tidyverse}.
