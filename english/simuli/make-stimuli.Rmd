...
words <- c("teep", "teeb", "turp", "turb", "tarp", "tarb", "teek", "teeg", "turk", "turg", "tark", "targ", "teepus", "teebus", "turpus", "turbus", "tarpus", "tarbus", "teekus", "teegus", "turkus", "turgus", "tarkus", "targus")

for (frame in 1:length(frames)) {
  cat(str_glue(frames[frame], word = words), sep = "\n")
}
```
