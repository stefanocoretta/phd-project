...
![A schematic representation of the electroglottograph. The trasnversal section of the neck at the level of the glottis is represented: the effect of the glottis are shown on the left (open glottis) and on the right figure (closed glottis).\label{f:egg-setup}](../graphics/egg-setup.pdf){ width=80% }

# Methodology

This section describes the equipment setup, the procedure for the acquisition, synchronisation, and analysis of the UTI and EGG data.
Statistical testing will be the subject of \Cref{s:stats}.
...
Previous studies have shown that the mathematical first derivative of the EGG signal helps determine the moments of glottal closure and opening in each vibration cycle, or glottal period [].
