...
## Acquisition and post-processing of ultrasound and EGG

Ultrasound and EGG inputs are acquired and recorded in separate laptops by means of, respectively, Articulate Assistant Advanced [AAA, ] and Praat [].
Detection of tongue profile and calculation of velocity measures and consonantal target and release are automatically performed in AAA using built-in functions.
EGG post-processing is described in \Cref{s:tracegram}.
...
## Calculation of dEGG and tracegram analysis {#s:tracegram}
...
I ran a pilot study to assess the performance of the methodology.
...
![Tongue contour at maximum constriction of coronal consonants in Italian.\label{f:it-coronal}](../graphics/it-coronal.pdf){ width=90% }

![Tongue contour at maximum constriction of coronal consonants in Polish.\label{f:pl-coronal}](../graphics/pl-coronal.pdf){ width=90% }

\Cref{f:it-coronal} and \Cref{f:pl-coronal} show the tongue countours of the speaker of, respectively, Italian and Polish.
The contours at maximum closure of coronal consonants only are plotted, separately for each of the three vowels /a, o, u/ (columns) and speaker (rows).
