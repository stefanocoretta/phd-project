...
splines.raw <- list.files(path = "./voicing-effect/results/cached",
                   pattern = "*-aaa.csv",
                   full.names = TRUE) %>%
    map_df(~read.delim(., col.names = columns, na.strings = "*"))

splines.closure.raw <- list.files(path = "./voicing-effect/results/cached",
                   pattern = "*-closure.csv",
                   full.names = TRUE) %>%
    map_df(~read.delim(., col.names = columns, na.strings = "*"))

splines.phantom.raw <- list.files(path = "./voicing-effect/results/cached",
                   pattern = "*-phantom.csv",
                   full.names = TRUE) %>%
