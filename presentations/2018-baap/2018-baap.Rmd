...
```{r coeff-it}
kable(round(coef(vowels_it_lm)$speaker[1:2], 1), col.names = c("Intercept", "Voiced"))
```

```{r coeff-pl}
kable(round(coef(vowels_pl_lm)$speaker[1:2], 1), col.names = c("Intercept", "Voiced"))
```
...
* **General trends**
    ...
    * speakers with robust appreaciable TRA have stronger voicing effect
