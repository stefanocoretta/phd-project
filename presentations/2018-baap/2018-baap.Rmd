...
* generalised additive mixed effects models [@wood2006;@soskuthy2017;@soskuthy2017;@van-rij2017]
    * `rticulate` R package [@coretta2018]

* general trends
    * highly idiosyncratic use of TRA
    * speakers with robust TRA have stronger voicing effect
