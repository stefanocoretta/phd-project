...
\begin{figure}
  \centering
  \includegraphics{./graphics/degg-signal.pdf}
\end{figure}
...
## Background: Wavegrams 

* CQ reduces dimentionality of EGG signal

* @herbst2010 propose the wavegram as a multidimentional account of the EGG signal
...
## Background: Tracegram and Wavegram GAMs

* limitations
    * CQ is not precise [@baken1992; @herbst2017]
    * wavegram cannot be accessed statistically
...
* analysis window
    * 500 ms portion centred around mid point of each token
...
\begin{figure}
  \centering
  \includegraphics{./graphics/tracegram.pdf}
\end{figure}
...
* statistical testing of wavegram data
    * heat-map plots: time, period, amplitude
