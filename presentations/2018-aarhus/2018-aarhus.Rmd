...
```{r italian-gam-plot}
png(filename = "./presentations/2018-aarhus/fig/it-voiceless-wavegram.png", height = 768, width = 1024)
fvisgam(
  italian_gam,
  ...
  zlim = c(0, 1),
  rm.ranef = TRUE,
  main = "Wavegram of vowels followed by voiceless stops",
  xlab = "Vowel proportion",
  ylab = ""
)
dev.off()

png(filename = "./presentations/2018-aarhus/fig/it-voiced-wavegram.png", height = 768, width = 1024)
fvisgam(
  italian_gam,
  view = c("sequence_prop","sample"),
  ...
  zlim = c(0, 1),
  rm.ranef = TRUE,
  main = "Wavegram of vowels followed by voiced stops",
  xlab = "Vowel proportion",
  ylab = ""
)
dev.off()
...
```{r polish-gam-plot}
png(filename = "./presentations/2018-aarhus/fig/pl-voiceless-wavegram.png", height = 768, width = 1024)
fvisgam(
  polish_gam,
  view = c("sequence_prop","sample"),
  cond = list(c2_phonation = "voiceless"),
...
png(filename = "./presentations/2018-aarhus/fig/pl-voiced-wavegram.png", height = 768, width = 1024)
fvisgam(
  polish_gam,
  view = c("sequence_prop","sample"),
  cond = list(c2_phonation = "voiced"),
