...
```{r wave-gam}
if (file.exists("./italian-polish/data/cache/wave_gam.Rds")) {
  load("./italian-polish/data/cache/wave_gam.Rds")
} else {
  wave_gam <- bam(
    amplitude ~
      lang_voice_o +
  ...
  save(wave_gam, file = "./italian-polish/data/cache/wave_gam.Rds")
}
```
...
if (file.exists("./italian-polish/data/cache/wave_gam_ar.Rds")) {
  load("./italian-polish/data/cache/wave_gam_ar.Rds")
} else {
  wave_gam_ar <- bam(
    amplitude ~
      lang_voice_o +
  ...
  save(wave_gam_ar, file = "./italian-polish/data/cache/wave_gam_ar.Rds")
}
```

```{r wave-gam-ar-0}
if (file.exists("./italian-polish/data/cache/wave_gam_ar_0.Rds")) {
  load("./italian-polish/data/cache/wave_gam_ar_0.Rds")
} else {
  wave_gam_ar_0 <- bam(
    amplitude ~
      # lang_voice_o +
  ...
  save(wave_gam_ar_0, file = "./italian-polish/data/cache/wave_gam_ar_0.Rds")
}
```
