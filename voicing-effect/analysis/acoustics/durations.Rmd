...
as_tibble(ranef(vowdur_lm)$speaker[2], rownames = "speaker") %>%
  ...
  labs(title = "By-speaker conditional modes", y = "msec")
```
...
as_tibble(ranef(vowdur_lm)$speaker[1], rownames = "speaker") %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "By-speaker random intercepts", y = "Vowel duration (msec)")
```
...
No correlation between vowel duration random intercept and random coefficient (slope).
