...
x_1 <- c(coord$X[coord$fan_line == 1][1], coord$X[coord$fan_line == 1][2])
y_1 <- c(coord$Y[coord$fan_line == 1][1], coord$Y[coord$fan_line == 1][2])

x_2 <- c(coord$X[coord$fan_line == 2][1], coord$X[coord$fan_line == 2][2])
y_2 <- c(coord$Y[coord$fan_line == 2][1], coord$Y[coord$fan_line == 2][2])
