...
1. **Export data** in `datasets/ultrasound/` folder
    1. `Export-tongue-cart.xsu`: export cartesian coordinates at peaks, nucleus onset and offset, and maximum (Annotation: "_"), `[ID]-tongue-cart.tsv`
    1. `Export-tongue-clos-cart.xsu`: export cartesian coordinates at acoustic closure (Annotation: vowel) `[ID]-tongue-clos-cart.tsv`
    1. `Export-closing-gons.xsu`: export closing gesture onset (Annotation: "GONS") `[ID]-closing-gons.tsv`
