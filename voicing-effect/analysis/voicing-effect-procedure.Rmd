...
1. **Calculate kinematics**
    1. Check relevant splines for Tongue Dorsum, Tongue Tip, and Tongue Root
...
1. **Export data** in `datasets/ultrasound/` folder
    1. `Export-tongue-cart.xsu`: export cartesian coordinates at peaks, nucleus onset and offset, and maximum, `[ID]-tongue-cart.tsv`
    1. `Export-tongue-clos-cart.xsu`: export cartesian coordinates at acoustic closure `[ID]-tongue-clos-cart.tsv`
    1. `Export-closing-gons.xsu`: export closing gesture onset `[ID]-closing-gons.tsv`
    1. `Export-tra-cart.xsu`: export tongue root displacement at maximum `[ID]-tra-cart.tsv`
...
languages <- c("it", "it", "it", "it", "pl", "pl", "pl", "pl")
