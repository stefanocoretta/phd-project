...
A high frequency low voltage electrical current is sent through two electrodes which are in contact with the surface of neck, one on each side of the thyroid cartilage.
Depending on the amount of VFCA, the amplitude of the current increases (with higher VFCA) or decreases (with lower VFCA).
