...
Longer voicing during closure in non-low vowels could be linked with differences in laryngeal configurations: for example, \citet{koenig2011} find that voice onset happens at higher intra-oral pressures when the vowel is high compared to when the vowel is low (they compared /i, ɪ/ vs. /ɑ/).
These results indicate a certain temporal independence between supralaryngeal and laryngeal gestures at vowel offset: possibly, the speaker exercises more control over the phasing of the lingual gestures than the phasing of vocal fold vibration.
I also have results on other measures which I will include in a next report.
