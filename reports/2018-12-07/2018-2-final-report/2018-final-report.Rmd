...
This report discusses a selection of results from an exploratory study concerning the acoustic and articulatory properties of VC sequences in C**VC**V words in Italian and Polish.
...
All data has now been processed for subsequent analysis, which is still ongoing but nearest completion.
...
Next, the articulatory data concerning the position of the tongue root during the production of vowels and consonants in VC sequences will be discussed.

## Acoustic data

### Vowel duration

In agreement with @farnetani1986, @esposito2002, and @nowak2006, Italian and Polish show an effect of consonantal voicing on preceding vowel duration.
...
These estimates are different from the one found in this study (15 ms), but several factors might have played a role in contributing to such difference.
...
The closure duration of voiceless stops is 16 ms longer than that of voiced stops [@davis1989; @fowler1992].
...
The correlation between vowel and closure durations holds independently of the voicing of the consonant, such that, within a word, longer vowel duration correlates with shorter closure duration [@davis1989].
...
\begin{figure}
  \centering
  \caption{Schematic representation of the trade-off account for the voicing effect.}
  \includegraphics[width=\textwidth]{../../graphics/trade-off-2.pdf}
\end{figure}
