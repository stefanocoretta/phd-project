---
title: 'Exploratory study on acoustic and articulatory properties of VC sequences in Italian and Polish'
...
The following sections report on a selection of results from the exploratory study run during the period 2016-2018.
The study was meant to...
The acoustic data will be presented first, with a focus on vowel and consonant closure duration in C1VC2V words as a function of the voicing of C2.
Evidence in support of a durational trade-off account of the so called 'voicing effect' will be offered.
Next, the articulatory data concerning the position of the tongue root during the production of a VC sequence will be discussed.
...
Vowel are shorter when followed by voiceless stops, while they are longer when followed by voiced stops.\footnote{\citet{farnetani1986} reported a 35 ms effect in Italian, while \citet{nowak2006} a 4.5 ms effect in Polish.}
...
The data collected in this exploratory study brings new evidence in support to the trade-off account, by offering a suitable invariant interval: the Release to Release interval (RR), i.e. the interval between the release of C1 and the release of C2 in CVCV words.
...
According to an LMER, vowel identity and C2 place of articulation have an effect in Italian but not in Polish.
...
It thus appears that the durational difference of vowels as a function of the voicing of following consonants is a by-product of the invariance in duration of the interval between two consecutive releases.
...
Given that the difference in tongue root position (in those speakers who have one) can be observed already at closure onset, it is expected that the advancing gesture is initiated before closure is achieved.
This implies that the onset of the advancing gesture (relative to the position of the tongue root at vowel onset) happens during the production of the vowel, prediction born out by the data recorded in this study, although the gesture is found both in vowels preceding voiced *and* voiceless stops.
...
It is not clear at this stage whether the advancing gesture found in vowels followed by voiceless stops is just a consequence of the body of the tongue raising towards the palate for the production of an oral occlusion.
Probably comparison with sonorant consonants is required in order to confirm this possibility.
However, the fact to keep in mind is that an enlarged cavity for voiced stops compared to voiceless stops is produced, independent of the position of the root at vowel offset relative to its position at vowel onset.

### Vowel duration and tongue root position

Although the effect of voicing on vowel duration and tongue root position are decoupled, vowel duration and tongue root position are instead positively correlated.
Longer vowel durations correspond with a more advanced tongue root position, and vice versa, shorter vowel durations correspond with a less advanced tonge root.
