...
voicing <- read_csv("./lombard/results/voicing.csv", na = "--undefined--") %>%
    ...
    mutate(
        ...
        devoiced = ifelse(
            voicing_duration < consonant_duration / 5, "devoiced_1",
            ifelse(
                voicing_duration < consonant_duration / 5 * 2, "devoiced_2",
                ifelse(
                    voicing_duration < consonant_duration / 5 * 3, "devoiced_3",
                    ifelse(
                        voicing_duration < consonant_duration / 5 * 4, "devoiced_4",
                        "voiced"
                    )
                )
            )
