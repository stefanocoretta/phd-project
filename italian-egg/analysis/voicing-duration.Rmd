...
Relative to the duration of low vowels (/a/), mid-high vowels (/e/) are 24ms shorter, and high vowels (/i/, /u/) are 36ms shorter.
In comparison, voicing in mid-high vowels is 16ms shorter, and it is 27ms shorter in high vowels.
There's seems to be a 10ms gap in shortnening between vowel and voicing duration (vowel shortening magnitude is greater).
