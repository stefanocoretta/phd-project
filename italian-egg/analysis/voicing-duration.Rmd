...
```{r voice-lm-1-pred}
plot_model(voice_lm_1, type = "pred", terms = "height")
```
...
```{r vowel-lm-pred}
plot_model(vowel_lm, type = "pred", terms = "height")
```
...
```{r rel-voff-lm-plot}
plot_model(rel_voff_lm, type = "pred", terms = c("height", "c1_place", "speech_rate_c"))
```
